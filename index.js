...
var monsterList = {
  //이름, 레벨, HP, 공격력, 방어력, 행운
  0: [
    ["육구단 타입A", 1, 90, 45, 10, 0],
    ["육구단 타입B", 1, 90, 52, 15, 12],
    ["육구단 타입C", 1, 90, 50, 20, 11]
  ],
  1: [
    ["욕구단 타입A", 1, 90, 56, 23, 0],
    ["욕구단 타입B", 1, 90, 47, 19, 0],
    ["욕구단 타입C", 1, 90, 43, 21, 0],
    ["욕구단 타입D", 1, 90, 51, 69, 0]
  ],
  2: [
    ["쭈매니저", 1, 90, 60, 25, 15],
    ["독매니저", 1, 90, 70, 28, 12],
