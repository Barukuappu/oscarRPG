...
var monsterList = {
  //이름, 레벨, HP, 공격력, 방어력, 행운
  0: [
    ["육구단 타입A", 1, 40, 45, 10, 0],
    ["육구단 타입B", 1, 54, 52, 15, 20],
    ["육구단 타입C", 1, 61, 50, 20, 11]
  ],
  1: [
    ["욕구단 타입A", 3, 70, 81, 28, 18],
    ["욕구단 타입B", 3, 75, 84, 39, 30],
    ["욕구단 타입C", 3, 78, 91, 46, 30],
    ["욕구단 타입D", 3, 81, 88, 67, 30]
  ],
  2: [
    ["쭈매니저", 5, 90, 92, 50, 20],
    ["독매니저", 5, 75, 100, 50, 1],
